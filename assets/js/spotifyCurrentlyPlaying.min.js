    ...
    SpotifyCurrentlyPlaying.prototype = {
        ...
        displayPlayer: function() {
            ...
            self.queryLastfm(function() {
              ...
              paragraph.appendChild(document.createTextNode('Now Playing:'));
              paragraph.appendChild(document.createElement('br'));
              paragraph.appendChild(document.createTextNode(self.lastfm_tracks[0].title + " by " + self.lastfm_tracks[0].artist));
